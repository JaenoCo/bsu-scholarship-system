...
class Form extends Model
{
    ...
    /**
     * Calculate overall progress percentage using only required fields.
     * Optional fields do not affect the completion status of the application.
     */
    public function getOverallProgress()
    {
        return $this->getRequiredFieldsProgress();
    }
