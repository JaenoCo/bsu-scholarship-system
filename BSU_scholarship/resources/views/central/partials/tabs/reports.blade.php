<div x-show="tab === 'sfao-reports' || tab === 'sfao_reports'" 
    ...
    <div class="space-y-6">
        <div class="flex justify-end">
            <a href="{{ route('central.reports.overall') }}"
               class="inline-flex items-center px-4 py-2 bg-bsu-red border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-bsu-redDark focus:outline-none focus:ring-2 focus:ring-bsu-red focus:ring-offset-2 transition">
