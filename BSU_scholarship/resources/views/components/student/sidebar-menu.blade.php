    ...
    <nav class="mt-6 px-4 pb-4 overflow-y-auto flex-1 space-y-4 custom-scrollbar">
      ...
      <div class="space-y-1">
        ...
        <button type="button" @click="tab = 'scholarships'; subTab = 'all'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'scholarships' && subTab === 'all') ? 'bg-white text-bsu-red' : 'text-white'">
        ...
        <button type="button" @click="tab = 'scholarships'; subTab = 'private'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'scholarships' && subTab === 'private') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button type="button" @click="tab = 'scholarships'; subTab = 'government'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'scholarships' && subTab === 'government') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="space-y-1">
        ...
        <button type="button" @click="tab = 'scholarships'; subTab = 'form'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'scholarships' && subTab === 'form') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button type="button" @click="tab = 'scholarships'; subTab = 'gvsreap_form'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'scholarships' && subTab === 'gvsreap_form') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
      ...
      <div class="space-y-1">
        ...
        <button type="button" @click="tab = 'applied-scholarships'; subTab = 'all'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'applied-scholarships' && subTab === 'all') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path d="M12 14l9-5-9-5-9 5 9 5z" />
            <path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" />
        ...
        <button type="button" @click="tab = 'applied-scholarships'; subTab = 'tracking'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'applied-scholarships' && subTab === 'tracking') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="space-y-1">
        ...
        <button type="button" @click="tab = 'notifications'; subTab = 'all'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'notifications' && (subTab === 'all' || !subTab)) ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button type="button" @click="tab = 'notifications'; subTab = 'scholarship_created'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'notifications' && subTab === 'scholarship_created') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path d="M12 14l9-5-9-5-9 5 9 5z" />
            <path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" />
        ...
        <button type="button" @click="tab = 'notifications'; subTab = 'application_status'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'notifications' && subTab === 'application_status') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button type="button" @click="tab = 'notifications'; subTab = 'sfao_comment'"
                class="w-full text-left px-4 py-2 rounded transition text-sm flex items-center gap-2"
                :class="(tab === 'notifications' && subTab === 'sfao_comment') ? 'bg-white text-bsu-red' : 'text-white'">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
