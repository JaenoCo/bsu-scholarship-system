...
@section('navbar-title', 'Document Evaluation | SFAO Requirements')
@section('back-url', route('sfao.evaluation.show', ['user_id' => $student->id]))
@section('back-text', 'Back to Selection')
