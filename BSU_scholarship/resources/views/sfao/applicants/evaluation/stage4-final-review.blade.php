...
@section('navbar-title', 'Document Evaluation | Final Review')
@section('back-url', route('sfao.evaluation.scholarship-documents', ['user_id' => $student->id, 'scholarship_id' => $scholarship->id]))
@section('back-text', 'Back to Scholarship Docs')
        ...
        <div class="mb-8">
            @if(request('from_status'))
                ...
                <div class="flex items-center justify-center space-x-2">
                    ...
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-bsu-red text-white rounded-full flex items-center justify-center text-sm font-bold">
