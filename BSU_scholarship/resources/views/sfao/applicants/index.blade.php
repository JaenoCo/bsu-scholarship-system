<div x-show="tab.startsWith('applicants')" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        <!-- Total Applicants -->
        <div @click="openStatusModal('all')" class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 cursor-pointer transition-all hover:shadow-lg" :class="filters.status === 'all' ? 'ring-2 ring-bsu-red' : ''">
        ...
        <!-- Not Applied -->
        <div @click="openStatusModal('not_applied')" class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 cursor-pointer transition-all hover:shadow-lg" :class="filters.status === 'not_applied' ? 'ring-2 ring-bsu-red' : ''">
            <div class="flex items-center">
        ...
        <!-- In Progress -->
        <div @click="openStatusModal('in_progress')" class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 cursor-pointer transition-all hover:shadow-lg" :class="filters.status === 'in_progress' ? 'ring-2 ring-bsu-red' : ''">
            <div class="flex items-center">
        ...
        <!-- Pending -->
        <div @click="openStatusModal('pending')" class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 cursor-pointer transition-all hover:shadow-lg" :class="filters.status === 'pending' ? 'ring-2 ring-bsu-red' : ''">
            <div class="flex items-center">
        ...
        <!-- Approved -->
        <div @click="openStatusModal('approved')" class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 cursor-pointer transition-all hover:shadow-lg" :class="filters.status === 'approved' ? 'ring-2 ring-bsu-red' : ''">
            <div class="flex items-center">
        ...
        <!-- Rejected -->
        <div @click="openStatusModal('rejected')" class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 cursor-pointer transition-all hover:shadow-lg" :class="filters.status === 'rejected' ? 'ring-2 ring-bsu-red' : ''">
            <div class="flex items-center">
